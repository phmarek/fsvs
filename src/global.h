 ...
 * Historically derived from filetypes.  */
#define FT_UNKNOWN (0)
#define FT_DIR (1)
#define FT_FILE (2)
#define FT_CDEV (4)
#define FT_BDEV (8)
#define FT_SYMLINK (16)
// sockets ?
#define FT_IGNORE (32) 
#define FT_ANY (FT_DIR | FT_FILE | FT_CDEV | FT_BDEV | FT_SYMLINK | FT_IGNORE)
#define FT_NONDIR (FT_ANY & ~FT_DIR)
#define FT_ANYSPECIAL (FT_NONDIR & ~FT_FILE)

#define FT__MASK (FT_ANY)
 ...
 * not changed, but some child, so this directories children have to be 
...
#define BUG(...) do { debuglevel=1; DEBUGP(__VA_ARGS__); *(int*)42=__LINE__; } while (0)
...
/** @{ */
/** If the user wants to make sure whether files have been modified
